...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Default
        {
            ...
            {
                public const string OrderItemIndex = "~/Modules/Default/OrderItem/OrderItemIndex.cshtml";
            }

            public static class Orders
            {
                public const string OrdersIndex = "~/Modules/Default/Orders/OrdersIndex.cshtml";
            }
