    ...
    declare namespace Db {
        ...
        namespace Default {
            ...
            namespace OrderItem {
                ...
                export const OrderOrderData: string;
                export const OrderOrderNumber: string;
                export const OrderTotalAmount: string;
                export const ProductId: string;
                export const ProductIsDiscontinued: string;
                export const ProductPackage: string;
            ...
            namespace Orders {
                ...
                export const CustomerLastName: string;
                export const CustomerPhone: string;
                export const Id: string;
                export const OrderData: string;
            ...
            namespace Product {
                export const Id: string;
                export const IsDiscontinued: string;
