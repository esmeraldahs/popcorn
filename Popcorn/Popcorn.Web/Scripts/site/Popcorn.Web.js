...
(function (Popcorn) {
    ...
    (function (Default) {
        ...
        [,
            ['OrderId', function () { return Serenity.IntegerEditor; }],
            ['ProductId', function () { return Serenity.IntegerEditor; }],
            ['UnitPrice', function () { return Serenity.IntegerEditor; }]
        ].forEach(function (x) { return Object.defineProperty(OrderItemForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (Popcorn) {
    ...
    (function (Default) {
        ...
        (function (OrderItemRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = OrderItemRow.Fields || (OrderItemRow.Fields = {}));
            [
                'Id',
                'OrderId',
                'ProductId',
...
(function (Popcorn) {
    ...
    (function (Default) {
        ...
        (function (OrderItemService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = OrderItemService.Methods || (OrderItemService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = OrderItemService.baseUrl + '/' + x;
            });
...
(function (Popcorn) {
    ...
    (function (Default) {
        ...
        [,
            ['OrderData', function () { return Serenity.DateEditor; }],
            ['OrderNumber', function () { return Serenity.StringEditor; }],
            ['CustomerId', function () { return Serenity.IntegerEditor; }],
            ['TotalAmount', function () { return Serenity.DecimalEditor; }]
        ].forEach(function (x) { return Object.defineProperty(OrdersForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (Popcorn) {
    ...
    (function (Default) {
        ...
        [,
            ['ProductName', function () { return Serenity.StringEditor; }],
            ...
            ['IsDiscontinued', function () { return Serenity.BooleanEditor; }]
        ].forEach(function (x) { return Object.defineProperty(ProductForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (Popcorn) {
    ...
    (function (Default) {
        ...
        ].forEach(function (x) { return Object.defineProperty(SupplierForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
