...
(function (Popcorn) {
    ...
    })(Administration = Popcorn.Administration || (Popcorn.Administration = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var Administration;
...
(function (Popcorn) {
    ...
    })(BasicSamples = Popcorn.BasicSamples || (Popcorn.BasicSamples = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Popcorn.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Popcorn.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Popcorn.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Popcorn) {
    ...
    })(Common = Popcorn.Common || (Popcorn.Common = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var Common;
...
(function (Popcorn) {
    ...
    })(Membership = Popcorn.Membership || (Popcorn.Membership = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var Membership;
...
(function (Popcorn) {
    ...
    })(Northwind = Popcorn.Northwind || (Popcorn.Northwind = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var Northwind;
...
(function (Popcorn) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Popcorn.Northwind.Gender', 'Popcorn.Northwind.Entities.Gender');
    })(Northwind = Popcorn.Northwind || (Popcorn.Northwind = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
...
(function (Popcorn) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'Popcorn.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = Popcorn.Northwind || (Popcorn.Northwind = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
...
(function (Popcorn) {
    ...
    })(Texts = Popcorn.Texts || (Popcorn.Texts = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var Administration;
...
(function (Popcorn) {
    ...
    })(Authorization = Popcorn.Authorization || (Popcorn.Authorization = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var Administration;
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        }(Popcorn.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Popcorn.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Popcorn.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Popcorn.Common.ReportHelper.execute({
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Popcorn.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Popcorn.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Popcorn.Northwind.OrderDialog();
                        ...
                        var chai = Popcorn.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Popcorn.Northwind.EmployeeRow.getLookup().items
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Popcorn.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Popcorn.Northwind.CategoryService.Retrieve({
        ...
        }(Popcorn.Northwind.CategoryDialog));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        }(Popcorn.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Popcorn.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Popcorn.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Popcorn.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Popcorn.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Popcorn.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Popcorn.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Popcorn.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Popcorn.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Popcorn.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Popcorn.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Popcorn.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return Popcorn.LanguageList.getValue();
            };
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        }(Popcorn.Northwind.SupplierDialog));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Popcorn.Northwind.SupplierGrid));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Popcorn.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Popcorn.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Popcorn.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Popcorn.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Popcorn.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Popcorn.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Popcorn.Northwind.CustomerDialog));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        }(Popcorn.Northwind.CustomerGrid));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = Popcorn.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(Popcorn.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Popcorn.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Popcorn.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Popcorn.Northwind.OrderDetailDialog));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        }(Popcorn.Northwind.OrderDetailsEditor));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Popcorn.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Popcorn.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Popcorn.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Popcorn.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Popcorn.BasicProgressDialog();
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        ...
        }(Popcorn.Common.BulkServiceAction));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Popcorn.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Popcorn.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Popcorn.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Popcorn.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Popcorn.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Popcorn.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Popcorn.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Popcorn) {
    ...
    Popcorn.SelectableEntityGrid = SelectableEntityGrid;
})(Popcorn || (Popcorn = {}));
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Popcorn.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Popcorn.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Popcorn.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Popcorn.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Popcorn.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Popcorn.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Popcorn.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Popcorn.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Popcorn.Northwind.ProductService.baseUrl; };
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Popcorn.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Popcorn.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Popcorn.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Popcorn.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Popcorn) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Popcorn.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Popcorn.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Popcorn.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (Popcorn) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Popcorn.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Popcorn.LanguageList || (Popcorn.LanguageList = {}));
})(Popcorn || (Popcorn = {}));
...
(function (Popcorn) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('Popcorn');
        Serenity.EntityDialog.defaultLanguageList = Popcorn.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Popcorn.ScriptInitialization || (Popcorn.ScriptInitialization = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    ...
    Popcorn.BasicProgressDialog = BasicProgressDialog;
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var DialogUtils;
    ...
    })(DialogUtils = Popcorn.DialogUtils || (Popcorn.DialogUtils = {}));
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var Common;
...
(function (Popcorn) {
    ...
    Popcorn.StaticTextBlock = StaticTextBlock;
})(Popcorn || (Popcorn = {}));
var Popcorn;
(function (Popcorn) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Popcorn.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=Popcorn.Web.js.map